...
const LandingPage = () => {
  return (  
          <ScrollView stickyHeaderIndices={[0]} style={{ backgroundColor:"#00C0F0" ,/**white is also nice */}}>
                  <Header name ="StudyArchieve" logIn="Login"  SignUp="Signup" signupScreen="webSignup" loginScreen="webLogin"/>
                  <View
                    style={
                      {
                        paddingTop:50,
