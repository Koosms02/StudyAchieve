    ...
    <View style={{paddingLeft:50, paddingRight:50 , paddingTop:20 ,paddingBottom:20 ,flex:1,}}>
      <ScrollView>
        <Text style={{fontWeight:'bold' , fontSize:20 , color:'#EF5350' , paddingBottom:50}}>Donate you study notes and help a fellow student</Text>
          <View style={{height:'130%' , width:'50%' , backgroundColor:'#B9F6CA' ,alignItems:'center' , justifyContent:'center',borderRadius:10 , borderStyle:'dashed' ,borderColor:'#EF5350', borderWidth:1}}> 
                ...
                <TouchableOpacity style={{height:'10%' , width:'10%' ,paddingRight:25,}}>
                  <View style={{height:'180%' , width:'230%' , backgroundColor:'#EF5350' , justifyContent:'center', borderRadius:10, alignItems:'center'}}>
